...
public class VaultDataProvider {
    public static void register() {
        if (Bukkit.getPluginManager().isPluginEnabled("Vault")) {
            ...
            DataKey.PREFIX.register(p -> chat != null, p -> Objects.requireNonNull(chat).getPlayerPrefix(p));
            DataKey.SUFFIX.register(p -> chat != null, p -> Objects.requireNonNull(chat).getPlayerSuffix(p));
